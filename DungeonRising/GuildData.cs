...
public static Dictionary<string, Dictionary<string, dynamic>> TenSkills = new Dictionary<string, Dictionary<string, dynamic>>{{"Acrobatics", new Dictionary<string, dynamic>{{"Name", "Acrobatics"}, }},
{"Axe Training", new Dictionary<string, dynamic>{{"Name", "Axe Training"}, }},
{"Backstab", new Dictionary<string, dynamic>{{"Name", "Backstab"}, }},
{"Bludgeon Training", new Dictionary<string, dynamic>{{"Name", "Bludgeon Training"}, }},
{"Bomb Training", new Dictionary<string, dynamic>{{"Name", "Bomb Training"}, }},
{"Bow Techniques", new Dictionary<string, dynamic>{{"Name", "Bow Techniques"}, }},
{"Bow Training", new Dictionary<string, dynamic>{{"Name", "Bow Training"}, }},
{"Breaker", new Dictionary<string, dynamic>{{"Name", "Breaker"}, }},
{"Confusion", new Dictionary<string, dynamic>{{"Name", "Confusion"}, }},
{"Dispel", new Dictionary<string, dynamic>{{"Name", "Dispel"}, }},
{"Fortify", new Dictionary<string, dynamic>{{"Name", "Fortify"}, }},
{"Herbalism", new Dictionary<string, dynamic>{{"Name", "Herbalism"}, }},
{"Hex Magic", new Dictionary<string, dynamic>{{"Name", "Hex Magic"}, }},
{"Insight", new Dictionary<string, dynamic>{{"Name", "Insight"}, }},
{"Knife Training", new Dictionary<string, dynamic>{{"Name", "Knife Training"}, }},
{"Leadership", new Dictionary<string, dynamic>{{"Name", "Leadership"}, }},
{"Mentalism", new Dictionary<string, dynamic>{{"Name", "Mentalism"}, }},
{"Persistent Arcana", new Dictionary<string, dynamic>{{"Name", "Persistent Arcana"}, }},
{"Plant Bane", new Dictionary<string, dynamic>{{"Name", "Plant Bane"}, }},
{"Poison Lore", new Dictionary<string, dynamic>{{"Name", "Poison Lore"}, }},
{"Potion Crafting", new Dictionary<string, dynamic>{{"Name", "Potion Crafting"}, }},
{"Prototype Crafting", new Dictionary<string, dynamic>{{"Name", "Prototype Crafting"}, }},
{"Quick Draw", new Dictionary<string, dynamic>{{"Name", "Quick Draw"}, }},
{"Repair", new Dictionary<string, dynamic>{{"Name", "Repair"}, }},
{"Ritual Magic", new Dictionary<string, dynamic>{{"Name", "Ritual Magic"}, }},
{"Saber Training", new Dictionary<string, dynamic>{{"Name", "Saber Training"}, }},
{"Scan", new Dictionary<string, dynamic>{{"Name", "Scan"}, }},
{"Taunt", new Dictionary<string, dynamic>{{"Name", "Taunt"}, }},
{"Teach", new Dictionary<string, dynamic>{{"Name", "Teach"}, }},
{"Telekinesis", new Dictionary<string, dynamic>{{"Name", "Telekinesis"}, }},
{"Unarmed Techniques", new Dictionary<string, dynamic>{{"Name", "Unarmed Techniques"}, }},
{"Unarmed Training", new Dictionary<string, dynamic>{{"Name", "Unarmed Training"}, }},
{"Vanish", new Dictionary<string, dynamic>{{"Name", "Vanish"}, }},
{"Vigilance", new Dictionary<string, dynamic>{{"Name", "Vigilance"}, }},
{"Ward Magic", new Dictionary<string, dynamic>{{"Name", "Ward Magic"}, }}};
