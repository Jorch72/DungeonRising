    ...
    public class GuildData
{
        ...
        public static HashDictionary<string, HashDictionary<string, dynamic>> AllSkills = new HashDictionary<string, HashDictionary<string, dynamic>>{
{"Acrobatics", new HashDictionary<string, dynamic>{{"Name", "Acrobatics"}, {"Kind", "Exploit"}, }},
{"Adhere", new HashDictionary<string, dynamic>{{"Name", "Adhere"}, {"Kind", "Power"}, }},
{"Anathema Magic", new HashDictionary<string, dynamic>{{"Name", "Anathema Magic"}, {"Kind", "Magic"}, }},
{"Animal Bane", new HashDictionary<string, dynamic>{{"Name", "Animal Bane"}, {"Kind", "Warfare"}, }},
{"Armor Crafting", new HashDictionary<string, dynamic>{{"Name", "Armor Crafting"}, {"Kind", "Task"}, }},
{"Artifact Crafting", new HashDictionary<string, dynamic>{{"Name", "Artifact Crafting"}, {"Kind", "Task"}, }},
{"Atomic Blast", new HashDictionary<string, dynamic>{{"Name", "Atomic Blast"}, {"Kind", "Power"}, }},
{"Atomic Magic", new HashDictionary<string, dynamic>{{"Name", "Atomic Magic"}, {"Kind", "Magic"}, }},
{"Axe Techniques", new HashDictionary<string, dynamic>{{"Name", "Axe Techniques"}, {"Kind", "Techniques"}, }},
{"Axe Training", new HashDictionary<string, dynamic>{{"Name", "Axe Training"}, {"Kind", "Training"}, }},
{"Backstab", new HashDictionary<string, dynamic>{{"Name", "Backstab"}, {"Kind", "Warfare"}, }},
{"Baleful Weapon", new HashDictionary<string, dynamic>{{"Name", "Baleful Weapon"}, {"Kind", "Power"}, }},
{"Benevolence", new HashDictionary<string, dynamic>{{"Name", "Benevolence"}, {"Kind", "Power"}, }},
{"Binding Seal", new HashDictionary<string, dynamic>{{"Name", "Binding Seal"}, {"Kind", "Power"}, }},
{"Blade Techniques", new HashDictionary<string, dynamic>{{"Name", "Blade Techniques"}, {"Kind", "Techniques"}, }},
{"Blade Training", new HashDictionary<string, dynamic>{{"Name", "Blade Training"}, {"Kind", "Training"}, }},
{"Bludgeon Techniques", new HashDictionary<string, dynamic>{{"Name", "Bludgeon Techniques"}, {"Kind", "Techniques"}, }},
{"Bludgeon Training", new HashDictionary<string, dynamic>{{"Name", "Bludgeon Training"}, {"Kind", "Training"}, }},
{"Bomb Training", new HashDictionary<string, dynamic>{{"Name", "Bomb Training"}, {"Kind", "Training"}, }},
{"Bow Techniques", new HashDictionary<string, dynamic>{{"Name", "Bow Techniques"}, {"Kind", "Techniques"}, }},
{"Bow Training", new HashDictionary<string, dynamic>{{"Name", "Bow Training"}, {"Kind", "Training"}, }},
{"Breaker", new HashDictionary<string, dynamic>{{"Name", "Breaker"}, {"Kind", "Exploit"}, }},
{"Celestial Bane", new HashDictionary<string, dynamic>{{"Name", "Celestial Bane"}, {"Kind", "Warfare"}, }},
{"Charge", new HashDictionary<string, dynamic>{{"Name", "Charge"}, {"Kind", "Exploit"}, }},
{"Charm Magic", new HashDictionary<string, dynamic>{{"Name", "Charm Magic"}, {"Kind", "Magic"}, }},
{"Cleanse", new HashDictionary<string, dynamic>{{"Name", "Cleanse"}, {"Kind", "Power"}, }},
{"Confusion", new HashDictionary<string, dynamic>{{"Name", "Confusion"}, {"Kind", "Stance"}, }},
{"Cosmic Magic", new HashDictionary<string, dynamic>{{"Name", "Cosmic Magic"}, {"Kind", "Magic"}, }},
{"Counterattack", new HashDictionary<string, dynamic>{{"Name", "Counterattack"}, {"Kind", "Stance"}, }},
{"Dark Magic", new HashDictionary<string, dynamic>{{"Name", "Dark Magic"}, {"Kind", "Magic"}, }},
{"Defile", new HashDictionary<string, dynamic>{{"Name", "Defile"}, {"Kind", "Power"}, }},
{"Dispel", new HashDictionary<string, dynamic>{{"Name", "Dispel"}, {"Kind", "Power"}, }},
{"Earth Magic", new HashDictionary<string, dynamic>{{"Name", "Earth Magic"}, {"Kind", "Magic"}, }},
{"Earthen Wall", new HashDictionary<string, dynamic>{{"Name", "Earthen Wall"}, {"Kind", "Power"}, }},
{"Earthshaking Weapon", new HashDictionary<string, dynamic>{{"Name", "Earthshaking Weapon"}, {"Kind", "Power"}, }},
{"Eldritch Rift", new HashDictionary<string, dynamic>{{"Name", "Eldritch Rift"}, {"Kind", "Power"}, }},
{"Fiend Bane", new HashDictionary<string, dynamic>{{"Name", "Fiend Bane"}, {"Kind", "Warfare"}, }},
{"Fiery Weapon", new HashDictionary<string, dynamic>{{"Name", "Fiery Weapon"}, {"Kind", "Power"}, }},
{"Fire Magic", new HashDictionary<string, dynamic>{{"Name", "Fire Magic"}, {"Kind", "Magic"}, }},
{"Food Crafting", new HashDictionary<string, dynamic>{{"Name", "Food Crafting"}, {"Kind", "Task"}, }},
{"Fortify", new HashDictionary<string, dynamic>{{"Name", "Fortify"}, {"Kind", "Task"}, }},
{"Fortune Magic", new HashDictionary<string, dynamic>{{"Name", "Fortune Magic"}, {"Kind", "Magic"}, }},
{"Fury", new HashDictionary<string, dynamic>{{"Name", "Fury"}, {"Kind", "Stance"}, }},
{"Garment Crafting", new HashDictionary<string, dynamic>{{"Name", "Garment Crafting"}, {"Kind", "Task"}, }},
{"General Training", new HashDictionary<string, dynamic>{{"Name", "General Training"}, {"Kind", "Training"}, }},
{"Gun Techniques", new HashDictionary<string, dynamic>{{"Name", "Gun Techniques"}, {"Kind", "Techniques"}, }},
{"Gun Training", new HashDictionary<string, dynamic>{{"Name", "Gun Training"}, {"Kind", "Training"}, }},
{"Hasten", new HashDictionary<string, dynamic>{{"Name", "Hasten"}, {"Kind", "Power"}, }},
{"Heal Magic", new HashDictionary<string, dynamic>{{"Name", "Heal Magic"}, {"Kind", "Magic"}, }},
{"Herbalism", new HashDictionary<string, dynamic>{{"Name", "Herbalism"}, {"Kind", "Task"}, }},
{"Hex Magic", new HashDictionary<string, dynamic>{{"Name", "Hex Magic"}, {"Kind", "Magic"}, }},
{"Ice Magic", new HashDictionary<string, dynamic>{{"Name", "Ice Magic"}, {"Kind", "Magic"}, }},
{"Infuse Armor", new HashDictionary<string, dynamic>{{"Name", "Infuse Armor"}, {"Kind", "Power"}, }},
{"Insight", new HashDictionary<string, dynamic>{{"Name", "Insight"}, {"Kind", "Awareness"}, }},
{"Knife Techniques", new HashDictionary<string, dynamic>{{"Name", "Knife Techniques"}, {"Kind", "Techniques"}, }},
{"Knife Training", new HashDictionary<string, dynamic>{{"Name", "Knife Training"}, {"Kind", "Training"}, }},
{"Leadership", new HashDictionary<string, dynamic>{{"Name", "Leadership"}, {"Kind", "Stance"}, }},
{"Light Magic", new HashDictionary<string, dynamic>{{"Name", "Light Magic"}, {"Kind", "Magic"}, }},
{"Linguistics", new HashDictionary<string, dynamic>{{"Name", "Linguistics"}, {"Kind", "Task"}, }},
{"Malevolence", new HashDictionary<string, dynamic>{{"Name", "Malevolence"}, {"Kind", "Power"}, }},
{"Mentalism", new HashDictionary<string, dynamic>{{"Name", "Mentalism"}, {"Kind", "Power"}, }},
{"Metal Magic", new HashDictionary<string, dynamic>{{"Name", "Metal Magic"}, {"Kind", "Magic"}, }},
{"Ooze Bane", new HashDictionary<string, dynamic>{{"Name", "Ooze Bane"}, {"Kind", "Warfare"}, }},
{"Otherworldly Weapon", new HashDictionary<string, dynamic>{{"Name", "Otherworldly Weapon"}, {"Kind", "Power"}, }},
{"Pain Surge", new HashDictionary<string, dynamic>{{"Name", "Pain Surge"}, {"Kind", "Warfare"}, }},
{"Persistent Arcana", new HashDictionary<string, dynamic>{{"Name", "Persistent Arcana"}, }},
{"Persuasion", new HashDictionary<string, dynamic>{{"Name", "Persuasion"}, {"Kind", "Task"}, }},
{"Plant Bane", new HashDictionary<string, dynamic>{{"Name", "Plant Bane"}, {"Kind", "Warfare"}, }},
{"Poison Lore", new HashDictionary<string, dynamic>{{"Name", "Poison Lore"}, {"Kind", "Warfare"}, }},
{"Potent Arcana", new HashDictionary<string, dynamic>{{"Name", "Potent Arcana"}, {"Kind", "Warfare"}, }},
{"Potion Crafting", new HashDictionary<string, dynamic>{{"Name", "Potion Crafting"}, {"Kind", "Task"}, }},
{"Precise Arcana", new HashDictionary<string, dynamic>{{"Name", "Precise Arcana"}, {"Kind", "Warfare"}, }},
{"Prototype Crafting", new HashDictionary<string, dynamic>{{"Name", "Prototype Crafting"}, {"Kind", "Task"}, }},
{"Quick Draw", new HashDictionary<string, dynamic>{{"Name", "Quick Draw"}, {"Kind", "Exploit"}, }},
{"Radiance", new HashDictionary<string, dynamic>{{"Name", "Radiance"}, {"Kind", "Power"}, }},
{"Regenerate", new HashDictionary<string, dynamic>{{"Name", "Regenerate"}, {"Kind", "Power"}, }},
{"Repair", new HashDictionary<string, dynamic>{{"Name", "Repair"}, {"Kind", "Task"}, }},
{"Rising Tide", new HashDictionary<string, dynamic>{{"Name", "Rising Tide"}, {"Kind", "Power"}, }},
{"Ritual Magic", new HashDictionary<string, dynamic>{{"Name", "Ritual Magic"}, {"Kind", "Magic"}, }},
{"Roar", new HashDictionary<string, dynamic>{{"Name", "Roar"}, {"Kind", "Exploit"}, }},
{"Saber Techniques", new HashDictionary<string, dynamic>{{"Name", "Saber Techniques"}, {"Kind", "Techniques"}, }},
{"Saber Training", new HashDictionary<string, dynamic>{{"Name", "Saber Training"}, {"Kind", "Training"}, }},
{"Sacred Weapon", new HashDictionary<string, dynamic>{{"Name", "Sacred Weapon"}, {"Kind", "Power"}, }},
{"Scan", new HashDictionary<string, dynamic>{{"Name", "Scan"}, {"Kind", "Awareness"}, }},
{"Shining Weapon", new HashDictionary<string, dynamic>{{"Name", "Shining Weapon"}, {"Kind", "Power"}, }},
{"Sound Magic", new HashDictionary<string, dynamic>{{"Name", "Sound Magic"}, {"Kind", "Magic"}, }},
{"Spear Techniques", new HashDictionary<string, dynamic>{{"Name", "Spear Techniques"}, {"Kind", "Techniques"}, }},
{"Spear Training", new HashDictionary<string, dynamic>{{"Name", "Spear Training"}, {"Kind", "Training"}, }},
{"Storm Magic", new HashDictionary<string, dynamic>{{"Name", "Storm Magic"}, {"Kind", "Magic"}, }},
{"Taunt", new HashDictionary<string, dynamic>{{"Name", "Taunt"}, {"Kind", "Stance"}, }},
{"Teach", new HashDictionary<string, dynamic>{{"Name", "Teach"}, {"Kind", "Task"}, }},
{"Telekinesis", new HashDictionary<string, dynamic>{{"Name", "Telekinesis"}, {"Kind", "Power"}, }},
{"Terrify", new HashDictionary<string, dynamic>{{"Name", "Terrify"}, {"Kind", "Exploit"}, }},
{"Time Magic", new HashDictionary<string, dynamic>{{"Name", "Time Magic"}, {"Kind", "Magic"}, }},
{"Tornado Weapon", new HashDictionary<string, dynamic>{{"Name", "Tornado Weapon"}, {"Kind", "Power"}, }},
{"Unarmed Techniques", new HashDictionary<string, dynamic>{{"Name", "Unarmed Techniques"}, {"Kind", "Techniques"}, }},
{"Unarmed Training", new HashDictionary<string, dynamic>{{"Name", "Unarmed Training"}, {"Kind", "Training"}, }},
{"Vanish", new HashDictionary<string, dynamic>{{"Name", "Vanish"}, {"Kind", "Power"}, }},
{"Vigilance", new HashDictionary<string, dynamic>{{"Name", "Vigilance"}, {"Kind", "Awareness"}, }},
{"Vile Morph", new HashDictionary<string, dynamic>{{"Name", "Vile Morph"}, {"Kind", "Power"}, }},
{"Ward Magic", new HashDictionary<string, dynamic>{{"Name", "Ward Magic"}, {"Kind", "Magic"}, }},
{"Water Magic", new HashDictionary<string, dynamic>{{"Name", "Water Magic"}, {"Kind", "Magic"}, }},
{"Weapon Crafting", new HashDictionary<string, dynamic>{{"Name", "Weapon Crafting"}, {"Kind", "Task"}, }},
{"Whip Techniques", new HashDictionary<string, dynamic>{{"Name", "Whip Techniques"}, {"Kind", "Techniques"}, }},
{"Whip Training", new HashDictionary<string, dynamic>{{"Name", "Whip Training"}, {"Kind", "Training"}, }},
{"Wild Morph", new HashDictionary<string, dynamic>{{"Name", "Wild Morph"}, {"Kind", "Power"}, }},
{"Wind Magic", new HashDictionary<string, dynamic>{{"Name", "Wind Magic"}, {"Kind", "Magic"}, }},
};
